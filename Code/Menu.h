...
public:
    ...
    /**
     * This function develops a page of the user interface designed to change the file from which the network is being loaded.
     */
    void change_file();
    ...
    /**
     * This function develops a page of the user interface where the user can decide if they want to determine the most affected stations in a network with segment failures by searching the network edge by edge or all at the same time.
     */
    void Task4_2_2();

    /**
     * This function develops a page of the user interface with the data given by the Task4_2_3 function defined in Graph.h (Top k most affected stations when all segments fail or when only the specified segments fail). This function analyses the network edge by edge.
     */
    void Task4_2_2_aux_1();

    /**
     * This function develops a page of the user interface with the data given by the Task4_2_2 function defined in Graph.h (Top k most affected stations when specified segments fail). This function analyses all the edges of the network at the same time.
     */
